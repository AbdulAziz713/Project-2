                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>
                                        ...
                                        $data_barang = mysqli_query($koneksi, "SELECT * FROM features");
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>
                                        ...
                                        $data_barang = mysqli_query($koneksi, "SELECT * FROM packages");
                                        $jumlah_barang = mysqli_num_rows($data_barang);
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>
                                        ...
                                        $data_barang = mysqli_query($koneksi, "SELECT * FROM blog");
                                        $jumlah_barang = mysqli_num_rows($data_barang);
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ps-3">
                                    <h6>
                                        ...
                                        $data_barang = mysqli_query($koneksi, "SELECT * FROM testimonial");
                                        $jumlah_barang = mysqli_num_rows($data_barang);
